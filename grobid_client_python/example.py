...
if __name__ == "__main__":
    ...
    google_drive_link = "./tests/test_pdf"
    client = GrobidClient(config_path="./config.json")
    client.process("processFulltextDocument", google_drive_link, output="./tests/test_out/", consolidate_citations=False, tei_coordinates=True, force=False)
...
# Example usage:
xml_path = r'D:\igl_project\grobid_client_python\tests\test_out\test.grobid.tei.xml'
json_path = r'D:\igl_project\grobid_client_python\tests\test_out\Jsonfile.json'
